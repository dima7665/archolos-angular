...
import { SwitchComponent } from '../../../switch/components/switch/switch.component';
...
@Component({
	...
	imports: [MatCheckboxModule, ValidationModule],
  providers: [
...
export class CheckboxComponent implements ControlValueAccessor, ValidationControlElement {
  public readonly value = model(false);
	...
	public onToggleChange(event: MatCheckboxChange): void {
		this.markAsTouched();
